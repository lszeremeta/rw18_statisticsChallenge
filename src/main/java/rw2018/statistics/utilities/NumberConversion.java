 ...
 */
package rw2018.statistics.utilities;

/**
 * Converts primitive numerical values into a byte array and back again.
 * 
 * @author Daniel Janke &lt;danijankATuni-koblenz.de&gt;
 * @author Lars Bengel &lt;larsbengelATuni-koblenz.de&gt;
 */
public class NumberConversion {
  ...
  public static long bytes2long(byte[] bytes, int startIndex) {
	  return NumberConversion.bytes2long(bytes, startIndex, Long.BYTES);
  }
  ...
  public static byte[] long2bytes(long value) {
    ...
    NumberConversion.long2bytes(value, result, 0, Long.BYTES);
    return result;
  }
  
  public static byte[] long2bytes(long value, int length) {
	  byte[] result = new byte[length];
	  NumberConversion.long2bytes(value, result, 0, length);
	  return result;
  }
  
  public static void long2bytes(long value, byte[] destinationArray, int firstIndex) {
	  long2bytes(value, destinationArray, firstIndex, Long.BYTES);
  }
